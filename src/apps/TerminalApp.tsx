          ...
          <div className="sp-term-wrap">
            <div className="sp-web-toolbar">
              <ClassicyButtonToolbar size="small">
                <ClassicyButtonToolbarGroup>
                  <ClassicyButton buttonSize="small" onClickFunc={reconnect} disabled={status === 'connecting'}>
                    Reconnect
                  </ClassicyButton>
                </ClassicyButtonToolbarGroup>
              </ClassicyButtonToolbar>
              <span className={status === 'open' ? 'sp-dim' : 'sp-pulse'}>
                {status === 'connecting'
                  ? '连接中…'
                  : status === 'open'
                    ? '已连接'
            ...
            <div className="sp-term" ref={containerRef} />
          </div>
        )}
      </ClassicyWindow>
    </ClassicyApp>
